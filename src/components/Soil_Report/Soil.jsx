      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-center mb-8">
          <div className="text-center lg:text-left mb-4 lg:mb-0">
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-2 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">
              {t.title}
            </h1>
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-300 hover:border-blue-500 transition-all duration-200 hover:shadow-md"
            >
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-gray-200 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-2 h-10 bg-gradient-to-b from-green-500 to-green-600 rounded-full"></div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center mt-8">
              <button
                type="submit"
                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-all duration-300">
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">
                    <th className="p-4 text-left rounded-tl-2xl font-bold">{t.soilTable.nutrient}</th>
                    ...
                    <th className="p-4 text-center rounded-tr-2xl font-bold">
            ...
            <div className="flex justify-center mt-8">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-green-600 to-green-700 text-white font-bold rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                <span className="flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {showGraph && (
              <div className="mt-8 space-y-8">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-2 h-10 bg-gradient-to-b from-purple-500 to-purple-600 rounded-full"></div>
                    <h3 className="text-xl font-bold text-gray-800">{t.graphTitle}</h3>
                  </div>

                  <div className="flex justify-center gap-6 mb-6 flex-wrap">
                    <div className="flex items-center gap-2 bg-green-50 px-4 py-2 rounded-xl border-2 border-green-200 shadow-sm">
                      <div className="w-4 h-4 bg-green-500 rounded-lg shadow-sm"></div>
                      <span className="text-sm font-medium text-gray-700">
                        {language === "english" ? "Low" : "कमी"}
                      </span>
                    </div>
                    <div className="flex items-center gap-2 bg-yellow-50 px-4 py-2 rounded-xl border-2 border-yellow-200 shadow-sm">
                      <div className="w-4 h-4 bg-yellow-500 rounded-lg shadow-sm"></div>
                      <span className="text-sm font-medium text-gray-700">
                        {language === "english" ? "Optimal" : "इष्टतम"}
                      </span>
                    </div>
                    <div className="flex items-center gap-2 bg-red-50 px-4 py-2 rounded-xl border-2 border-red-200 shadow-sm">
                  ...
                  <div 
                    id="chart-container"
                    className="w-full h-80 bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl border-2 border-gray-200 shadow-inner"
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="bg-gradient-to-br from-green-50 to-blue-50 p-6 rounded-2xl border-2 border-green-200 shadow-sm hover:shadow-md transition-all duration-300">
                      ...
                      <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 rounded-2xl border-2 border-blue-200 shadow-sm hover:shadow-md transition-all duration-300">
                    ...
                    <div className="space-y-4">
                      <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-6 rounded-2xl border-2 border-yellow-200 shadow-sm hover:shadow-md transition-all duration-300">
                      ...
                      <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-2xl border-2 border-purple-200 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                {/* Footer Section */}
                <div className="text-center py-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl border-2 border-blue-200 shadow-sm">
                  <p className="text-xl font-bold text-gray-700 mb-6 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">
                    {t.healthySoil}
                  </p>
                  <div className="flex justify-center">
                    <button
                      onClick={handlePrint}
                      className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                    >
                      <span className="flex items-center gap-2">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
